...
class Addrti_sublink extends FormBase{
...
$result = $database->select('rti', 't')
    ->fields('t', ['id', 'rti_title','rti_title_hi', 'updated_on'])
    ->execute()
    ->fetchAll();
			$options[''] =  '--Select--';
 ...
 $file->save();	        
           ...
           $desen=$form_state->getValue('rti_sublink_name');
          ...
          $id = (\Drupal :: database () -> insert('rti_sublink'))
		  ->fields($fields)
		  ->execute();
