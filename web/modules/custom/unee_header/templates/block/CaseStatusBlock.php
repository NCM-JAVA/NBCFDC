...
class CaseStatusBlock extends BlockBase{
	public function build() {
		...
		$popular_html .='</ul>';
		$popular_html .='</div>';
		$popular_html .=  '<div class="action"><a href="./display-board/cases" title="View All " class="latest-update-viewall">View All</a></div>';
		$popular_html .=  '<div class="latest-update-tab-img"><img src="./sites/default/files/styles/large/public/2022-05/img-2.png?itok=7YrwNYnF" width="470" height="280" alt="Cause List" title="Cause List" loading="lazy" typeof="Image"></div>';
		return array(
	    		'#type'=> 'markup',
	      		'#markup' => $popular_html,	 		    
	      		// '#markup' => $test,			    
